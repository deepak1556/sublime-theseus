...
function log() {
  ...
  console.debug.apply(console, ["theseus: "].concat(args));
}
...
exports.devtoolTabDefinition = {
  ...
  build: function(iframeWindow, toolbox) {
    // init devtool tab
    TheseusDevtools.initialize(iframeWindow, toolbox);
    return Promise.resolve(TheseusDevtools);
  }
};

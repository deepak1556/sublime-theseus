...
this.EXPORTED_SYMBOLS = ["TheseusPanel"];
...
this.TheseusPanel = function TheseusPanel(iframeWindow, toolbox) {
...
TheseusPanel.prototype = {
  open: function() {
    ...
    return panelLoaded.promise
      ...
      .then(null, function onError(aReason) {
        Cu.reportError("TheseusPanel open failed. " +
  ...
  destroy: function() {
    ...
    return this._destroyer = this.panelWin.shutdown()
      ...
      .then(null, function onError(aReason) {
        Cu.reportError("TheseusPanel destroy failed. " +
                       aReason.error + ": " + aReason.message);
      });
  }
};
